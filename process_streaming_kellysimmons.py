...
INPUT_FILE_NAME = "forex_fundamental_news_for_usd.csv"
...
def prepare_message_from_row(row):
    ...
    date, ims_manufacturing, ism_services_pmi, housing_starts, non_farm_employment_change, unemployment_rate, consumer_price_index, producer_price_index, retail_ssales = row
    # use an fstring to create a message from our data
    # notice the f before the opening quote for our string?
    fstring_message = f"[{date}, {ims_manufacturing}, {ism_services_pmi}, {housing_starts}, {non_farm_employment_change}, {unemployment_rate, consumer_price_index}, {producer_price_index}, {retail_ssales}]"
